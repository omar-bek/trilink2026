...
$icons = [
    ...
    'arrow-right' => '<path stroke-linecap="round" stroke-linejoin="round" d="M5 12h14m0 0l-7-7m7 7l-7 7"/>',
    'arrow-left' => '<path stroke-linecap="round" stroke-linejoin="round" d="M19 12H5m0 0l7 7m-7-7l7-7"/>',
    ...
    'trend-up' => '<path stroke-linecap="round" stroke-linejoin="round" d="M2.25 18L9 11.25l4.306 4.307a11.95 11.95 0 015.814-5.519l2.74-1.22m0 0l-5.94-2.281m5.94 2.28l-2.28 5.941"/>',
...
@if($path)
<svg {{ $attributes->merge(['class' => $class]) }} fill="none" stroke="currentColor" stroke-width="{{ $attributes->get('stroke-width', '1.8') }}" viewBox="0 0 24 24" aria-hidden="true">{!! $path !!}</svg>
@endif
