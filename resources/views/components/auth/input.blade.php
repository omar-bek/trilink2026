...
<div>
    ...
    <input
        ...
        {{ $attributes->merge(['class' => 'w-full bg-page border rounded-lg px-4 py-3 text-[14px] text-primary placeholder:text-faint focus:outline-none focus:ring-2 transition-all ' . ($error ? 'border-red-500/60 focus:border-red-500 focus:ring-red-500/10' : 'border-th-border focus:border-accent/50 focus:ring-accent/10')]) }}
    />
    @if($error)
