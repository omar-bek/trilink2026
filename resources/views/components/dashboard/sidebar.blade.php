...
$nav = [
    ...
    'operations' => [
        ...
        'items' => [
            ...
            // Phase A — Bank Guarantees. Visible to every role that can
            // see contracts/escrow since it's core to any UAE B2B deal.
            ['key' => 'bank-guarantees', 'label' => __('bg.title'), 'route' => 'dashboard.bank-guarantees.index',
             ...
             'perm' => null],
            // Phase F — Bank Reconciliation. Finance-only UI.
            ['key' => 'reconciliation', 'label' => __('recon.title'), 'route' => 'dashboard.reconciliation.index',
    ...
    'settings' => [
        ...
        'items' => [
            ...
            ['key' => 'team-activity', 'label' => __('team_activity.nav_label'), 'route' => 'dashboard.team-activity.index',
             'icon' => 'M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z',
             'perm' => null, 'roles' => ['company_manager']],
