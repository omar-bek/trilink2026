...
@section('title', '429 — ' . __('errors.too_many_requests'))
...
<div class="min-h-[70vh] flex items-center justify-center px-4">
    <div class="relative w-full max-w-xl">
        <div class="absolute inset-0 -z-10 blur-3xl opacity-30 pointer-events-none"
             style="background: radial-gradient(circle at 30% 20%, rgba(139,92,246,0.25), transparent 60%),
        ...
        <div class="relative bg-surface border border-th-border rounded-3xl p-10 sm:p-12 text-center overflow-hidden shadow-[0_24px_60px_-20px_rgba(0,0,0,0.35)]">
            <div class="absolute inset-x-0 top-0 h-1"
                 style="background: linear-gradient(90deg, transparent 0%, var(--c-border) 15%, #8B5CF6 50%, var(--c-border) 85%, transparent 100%);">
            </div>
            ...
            <div class="relative w-24 h-24 mx-auto mb-6">
                <div class="absolute inset-0 rounded-full bg-[#8B5CF6]/10 animate-pulse"></div>
                <div class="absolute inset-2 rounded-full bg-[#8B5CF6]/15 border border-[#8B5CF6]/30 flex items-center justify-center">
                    <svg class="w-10 h-10 text-[#8B5CF6]" fill="none" stroke="currentColor" stroke-width="1.6" viewBox="0 0 24 24">
            ...
            <span class="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-[11px] font-mono font-bold text-[#8B5CF6] bg-[#8B5CF6]/10 border border-[#8B5CF6]/20 mb-4">
            ...
            <div class="pt-6 border-t border-th-border">
                <p class="text-[11px] text-faint">
                    {{ __('errors.too_many_requests_support') }}
