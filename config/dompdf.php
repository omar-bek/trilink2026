...
return [
    ...
    */
    ...
    'options' => [
         ...
         * @var string
         */
        // Arial is bundled into storage/fonts/ specifically because the
        // bilingual contract PDF renders Arabic clauses, and the default
        // DejaVu Sans Bold lacks coverage for parts of the Arabic
        // Presentation Forms-B block (the bold-styled headings come out as
        // ?????). Arial covers those glyphs and matches the look the
        // business signs off on for legal documents.
        'default_font' => 'Arial',
